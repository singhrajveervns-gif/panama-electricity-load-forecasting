...
KPI summary, a week-view forecast chart benchmarked against CND's real published forecast, a live per-hour SHAP explanation, and the full model card — all in the app itself.
