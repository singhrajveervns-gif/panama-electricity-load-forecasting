...
<p align="center">
  <img src="assets/eda_hourly_profile.png" alt="Average demand by hour of day" width="700">
  <br>
  <em>Average national demand by hour of day — the daily peak/trough cycle that drives most of the forecast</em>
</p>

<p align="center">
  <img src="assets/eda_weekly_pattern.png" alt="Weekday vs weekend demand profile" width="700">
  <br>
  <em>Weekday vs. weekend demand profile — weekends aren't just lower, they're a different shape</em>
</p>
...
<p align="center">
  <img src="assets/model_comparison_chart.png" alt="Ranked model comparison chart" width="750">
  <br>
  <em>Test-set MAE across every model and baseline — the selected model highlighted</em>
</p>
...
<p align="center">
  <img src="assets/benchmark_vs_operator.png" alt="Model vs CND operator forecast" width="750">
  <br>
  <em>Our forecast vs. CND's actual published forecast vs. real demand, one representative week</em>
</p>
...
<p align="center">
  <img src="assets/shap_global_importance.png" alt="SHAP global feature importance" width="650">
  <br>
  <em>Global feature importance by mean absolute SHAP value</em>
</p>

<p align="center">
  <img src="assets/shap_beeswarm.png" alt="SHAP beeswarm plot" width="650">
  <br>
  <em>SHAP beeswarm — feature value (colour) vs. impact on the forecast (position)</em>
</p>
...
<p align="center">
  <img src="assets/error_by_hour.png" alt="Forecast error by hour of day" width="750">
  <br>
  <em>MAE, MAPE, and bias by hour of day — the model under-forecasts precisely at the afternoon peak</em>
</p>
...
<p align="center">
  <img src="assets/covid_stress_test.png" alt="Model behaviour under the COVID-19 structural break" width="750">
  <br>
  <em>Daily mean demand: actual vs. forecast through the COVID-19 lockdown period</em>
</p>
