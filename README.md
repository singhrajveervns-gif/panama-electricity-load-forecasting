...
<p align="center">
  <img src="screenshot/dashboard_overview.png" alt="Streamlit Dashboard Overview" width="850">
  <br>
...
| | |
|---|---|
| <img src="screenshot/eda_hourly_profile.png" width="380"><br>*Average demand by hour of day* | <img src="screenshot/eda_weekly_pattern.png" width="380"><br>*Weekday vs. weekend demand profile* |
| <img src="screenshot/model_comparison_chart.png" width="380"><br>*Ranked test-set model comparison* | <img src="screenshot/benchmark_vs_operator.png" width="380"><br>*Model vs. CND's real published forecast* |
| <img src="screenshot/shap_global_importance.png" width="380"><br>*SHAP global feature importance* | <img src="screenshot/shap_beeswarm.png" width="380"><br>*SHAP beeswarm — direction and magnitude* |
| <img src="screenshot/error_by_hour.png" width="380"><br>*Forecast error by hour of day* | <img src="screenshot/covid_stress_test.png" width="380"><br>*Model behaviour under the COVID-19 structural break* |

### 🖥️ Streamlit Dashboard

| | |
|---|---|
| <img src="screenshot/dashboard_overview.png" width="380"><br>*KPI summary and week-view chart with the CND-forecast toggle* | <img src="screenshot/dashboard_hour_explainer.png" width="380"><br>*Live SHAP waterfall explaining a selected hour's forecast* |
| <img src="screenshot/dashboard_model_card.png" width="380"><br>*Model card and known limitations, expanded* | |
